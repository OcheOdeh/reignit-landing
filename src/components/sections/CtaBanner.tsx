    ...
    <section ref={ref} className="py-16 bg-dark-canvas relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p 
            className="text-xl text-neutral-smoke mb-8 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.6, delay: 0.2 }}
          >
            Book your free AI audit today and discover how our solutions can drive growth, efficiency, and innovation for your organization.
          </motion.p>
          ...
          >
            <Link href="#audit" className="cta-primary text-base px-8 py-4">
              Book Free AI Audit
            </Link>
          </motion.div>
        </div>
